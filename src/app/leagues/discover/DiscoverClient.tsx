...
import { Search, ArrowRight, Globe, Lock, Users, Hash } from 'lucide-react';
import type { League } from '@/lib/types';

export default function DiscoverClient({ initialLeagues }: { initialLeagues: League[] }) {
  ...
  const filtered = initialLeagues.filter(l =>
