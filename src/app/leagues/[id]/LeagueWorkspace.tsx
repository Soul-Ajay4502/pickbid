...
/**
 * The interactive league workspace: registration, squads, template picker,
 * sharing, auction entry points and every organizer control.
 *
 * Rendered by `page.tsx` for signed-in visitors, and for anyone holding the
